/**
 * pwa.js — Registro do Service Worker + prompt de instalação
 */
...
function showUpdateBanner() {
  ...
  banner.querySelector('button').style.cssText =
    'background:#2D6A4F;border:none;color:white;padding:6px 14px;border-radius:6px;cursor:pointer;font-size:0.8rem;font-weight:600';
...
export function setupInstallPrompt() {
  // Captura o evento antes que o browser o mostre
  ...
  // Remove o botão quando o app é instalado
...
function showInstallToast() {
  // Reutiliza o sistema de toast global
  if (window.__toast) {
