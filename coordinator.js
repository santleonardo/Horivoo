...
function openEditModal(data) {
  ...
  if (data.type === 'booked') {
    ...
    // Disponível — pode bloquear ou agendar
    studentFields.style.display = '';
    actionBtns.innerHTML = `
...
async function htmlToCanvas(gridEl) {
  // Coletar dados da grade para renderizar no canvas
